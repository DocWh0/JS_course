...
//Создать функцию, которая принимает произвольное число массивов и удаляет из каждого массива первый елемент и возвращает массив из оставшихся значений. 
...
//Создать функцию, которая принимает массив пользователей, поле которое хочу проверить и значение на которое хочу проверить указанное поле. Проверять что все агрументы переданы. Если что-то не передано то возвращать обьект ошибки "return new ("Error mwssage")" Возвращать новый массив с пользователями соответствующие указанными параметрам.
